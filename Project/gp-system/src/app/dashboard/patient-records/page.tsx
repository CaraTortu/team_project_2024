        ...
        medicalHistory: [
            {
                ...
                treatment: "Levothyroxine 100mcg daily",
            },
            {
                date: "2022-02-28",
                diagnosis: "Generalized Anxiety Disorder",
                treatment: "Escitalopram 10mg daily",
            },
        ],
        allergies: ["Latex"],
...
export default function DoctorPatientInfoPage() {
    ...
    const [filteredRecords, setFilteredRecords] =
        useState<PatientRecord[]>(patientRecords);
    ...
    const handleSearchChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFilteredRecords(
            patientRecords.filter((record) =>
                record.patientNumber.toLowerCase().includes(searchValue),
            ),
        );
    };
        ...
        <div className="flex-1 overflow-y-auto p-10">
            <div className="container mx-auto rounded bg-white p-6 shadow">
                ...
                <input
                    ...
                    className="mb-6 h-10 rounded-lg border-2 border-gray-300 bg-white px-5 pr-16 text-sm focus:outline-none"
                />
